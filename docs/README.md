...
| [E2](epics/E2-kv-store.md) | Key/value configuration store | 1 (foundation) | E1 (for commands) | [#2](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/2) |
| [E3](epics/E3-runtime-display.md) | Runtime display abstraction | 2 | E2 | [#3](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/3) |
| [E4](epics/E4-chip-family-builds.md) | Chip-family build consolidation | 2 | E3 | [#4](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/4) |
| [E5](epics/E5-text-console.md) | Diagnostic text console | 3 | E3 | [#5](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/5) |
| [E6](epics/E6-double-buffering.md) | Double buffering & multi-board sync | 3 | E3 | [#6](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/6) |
...
| [E8](epics/E8-firmware-update.md) | Firmware update | 3 → 4 | E1, E4 | [#36](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/36) |
