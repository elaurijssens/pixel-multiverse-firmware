...
### S4.1 — Family-driven CMake ([#22](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/22))
...
### S4.2 — Driver coexistence ([#23](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/23))
...
### S4.3 — CI builds both images ([#24](https://github.com/elaurijssens/pixel-multiverse-firmware/issues/24))
