...
### S3.1 — Board descriptor + selection
...
### S3.2 — Unified display implementation
...
### S3.3 — Driver dispatch (incl. Hub75 ISR)
...
### S3.5 — Configurable i75 / Plasma dimensions
